<?php /* Template Name: Защита авторских прав */?>
<?php get_header(); ?>
            ...
            <div class="info-block__inner">
                <div class="info-block__text">
                    ...
                    <p class="info-block__descr text text--normal text--light-dark text--w-light">
                        Авторское право – одна из форм интеллектуальной собственности, которая распространяется на произведения науки, литературы, искусства,программы для ЭВМ и базы данных.
                    </p>
                ...
                <div class="info-block__pic">
                    <img src="<?php echo STANDART_DIR; ?>img/info-block/defender-author.svg" alt="" class="info-block__img">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="text-block block-padding">
        <div class="text-block__body container">
            ...
            <div class="text-block__content wysiwyg">
                <p>
                    В России не предусмотрена обязательная процедура регистрации авторского права, поэтому многие не считают нужным оформлять его документально. Хотя в нашей стране существуют все необходимые механизмы.
                </p>
                <p>
                    Депонирование и учет объектов авторского права – процедура добровольной регистрации экземпляра произведения в специальном реестре с выдачей свидетельства и хранением данного экземпляра для подтверждения даты депонирования в случае возникновения судебных
                    споров. Ряд объектов, таких как программы для ЭВМ и баз данных, топологии интегральных микросхем, можно добровольно зарегистрировать в Роспатенте.
                </p>
                <p>
                    <b>

                Авторское право – одна из самых сложных сфер юриспруденции, поэтому важно обращаться к узкоспециализированным юристам, имеющим соответствующий практический опыт.

            </b>
                </p>
                <ol>
                    <li>Неимущественное право (бессрочное и неотчуждаемое);</li>
                    <li>Исключительное право на произведение (действует в течение всей жизни автора и 70 лет после);</li>
                    <li>Иные авторские права.</li>
                </ol>
            </div>
        </div>
    </section>
            ...
            <div class="period__inner period__inner--copyright">
                    ...
                    <div class="period__descr-wrapp">
                        ...
                        <div class="period__text-wrapp">
                            <div class="period__text text text--normal text--gray text--w-light">
                                Признание прав автором этого произведения
                            </div>
                        </div>
                    </div>
                </div>
                <div class="period__item period__item--copyright">
                    <div class="period__descr-wrapp">
                        ...
                        <div class="period__text-wrapp">
                            <div class="period__text text text--normal text--gray text--w-light">
                                Пресечение действий, создающих угрозу или нарушающих авторские права
                            </div>
                        </div>
                    </div>
                </div>
                <div class="period__item period__item--copyright">
                    <div class="period__descr-wrapp">
                        ...
                        <div class="period__text-wrapp">
                            <div class="period__text text text--normal text--gray text--w-light">
                                Взыскание компенсаций за нарушение авторских прав
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="banner__text">
                    ...
                    <div class="banner__action">
                        ...
                        <span class="button__act-text text text--normal text--small text--gray text--w-light">
                            Акция действует при заказе услуги "защита АП"
                        </span>
                    </div>
                </div>
                <div class="banner__pic">
                    <img src="<?php echo STANDART_DIR; ?>img/banner/banner-img-2.svg" alt="" class="banner__img">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="faq__accordion">
                <details class="faq__details">
                    <summary class="faq__summary">
                        <span class="faq__question text text--normal text--hight-dark text--w-light">Сотрудник, работающий по трудовому договору, сохраняет права на свои разработки, которые создал во время трудовой деятельности?</span>
                    </summary>
                    <div class="faq__answer text text--normal text--gray text--w-light">
                        Нет, если другое не предусмотрено отдельным соглашением. Так как сотрудник создал произведения в рамках своих трудовых обязанностей, то имущественные права на них принадлежат работодателю. Если вы привлекаете на какие-либо работы фрилансеров, то распределение
                        прав зависит от условий договора. Поэтому для обеих сторон важно заранее определить свою позицию и зафиксировать ее в документе.
                    </div>
                </details>
                <details class="faq__details">
                    <summary class="faq__summary">
                        <span class="faq__question text text--normal text--hight-dark text--w-light">Допускается ли редактирование чужих произведений? Например, обработка фотографии с помощью нейросети</span>
                    </summary>
                    <div class="faq__answer text text--normal text--gray text--w-light">
                        Любая переработка произведения считается его использованием и возможна только с разрешения правообладателя. Исключительное имущественное право действует в течение всей жизни автора и 70 лет после его смерти. При этом авторство, имя автора и неприкосновенность
                        произведения охраняются бессрочно.
                    </div>
                </details>
                <details class="faq__details">
                    <summary class="faq__summary">
                        <span class="faq__question text text--normal text--hight-dark text--w-light">Какие права возникают у автора произведения?</span>
                    </summary>
                    <div class="faq__answer text text--normal text--gray text--w-light">
                        Изначально автору принадлежат все права на произведение — имущественные и неимущественные. При этом исключительное имущественное право может быть предметом дальнейшего распоряжения. А право авторства и другие личные неимущественные права неотчуждаемы.
                    </div>
                </details>
            </div>
        </div>
