        ...
        <div class="faq__body container">
            ...
            <div class="faq__accordion">
                ...
                <details class="faq__details">
                    ...
                    <div class="faq__answer text text--normal text--gray text--w-light">
                        Правообладателем может быть как физическое, так и юридическое лицо, однако физическому лицу необходимо будет получить статус ИП. Правообладатель будет иметь исключительными правами на программу для ЭВМ, включая распространение, частичное или полное воспроизведение, а также модифицирование программы.
                    </div>
                </details>
                <details class="faq__details">
                    <summary class="faq__summary">
